...
def preprocess_dataset(input_data, save_data=False):
    ...
    :param save_data: Flag for saving the processed results to an autogenerated csv-file
    :type save_data: bool
...
def generate_evaluation_data(input_data, na_heating=51, na_cooling=-11, max_t=20000):
    ...
    :param na_heating: (optional) constant number to replace NaN values in heating column
    :type na_heating: int, float
    :param na_cooling: (optional) constant number to replace NaN values in cooling column
    :type na_cooling: int, float
    :param max_t: (optional) upper limit for time intervals
    :type max_t: int, float
